...
//userEvent method to simulate dropdown use
import userEvent from '@testing-library/user-event';

//import mock fetchShow axios call function
//import it as mockFetchShow to keep everything straight

import { fetchShow as mockFetchShow } from './api/fetchShow';

//shorcut that mocks everthing in the directory from Dustin
jest.mock('./api/fetchShow');

//data I want user event to select season 2
const allEps = {
  data: [
    {
      id: 2993,
